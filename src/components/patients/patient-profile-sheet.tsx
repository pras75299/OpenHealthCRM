    ...
    <SheetContent className="overflow-y-auto w-full sm:max-w-md md:sm:max-w-lg lg:max-w-xl border-l border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-950 p-0">
      ...
      <div className="px-6 pb-6 relative -mt-12">
        ...
        <div className="flex justify-between items-end mb-4">
          <div className="w-24 h-24 rounded-2xl bg-white dark:bg-neutral-900 border-4 border-white dark:border-neutral-950 shadow-xl flex items-center justify-center text-3xl font-bold text-indigo-600 dark:text-indigo-400">
            {patient.firstName[0]}{patient.lastName[0]}
          </div>
          <div className="mb-2">
            <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-emerald-100 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800/50 shadow-sm">
              {patient.status}
            </span>
          </div>
        </div>
        ...
        <div>
          ...
          <p className="text-sm font-medium text-neutral-500 mt-1 flex flex-wrap items-center gap-2">
            <span className="font-mono text-xs bg-neutral-200 dark:bg-neutral-800 px-1.5 py-0.5 rounded text-neutral-700 dark:text-neutral-300">
              MRN: {patient.mrn}
            </span>
            <span>•</span>
        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-indigo-50 dark:bg-indigo-900/20 p-3 rounded-xl border border-indigo-100 dark:border-indigo-800/30 flex flex-col items-center justify-center text-center">
            ...
            <div className="bg-rose-50 dark:bg-rose-900/20 p-3 rounded-xl border border-rose-100 dark:border-rose-800/30 flex flex-col items-center justify-center text-center">
            ...
            <div className="bg-emerald-50 dark:bg-emerald-900/20 p-3 rounded-xl border border-emerald-100 dark:border-emerald-800/30 flex flex-col items-center justify-center text-center">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-xl border border-blue-100 dark:border-blue-800/30 flex flex-col items-center justify-center text-center">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white dark:bg-neutral-900 border dark:border-neutral-800 rounded-2xl p-1 shadow-sm">
              <div className="flex flex-col">
                <div className="flex items-center gap-3 p-3 hover:bg-neutral-50 dark:hover:bg-neutral-800/50 rounded-xl transition-colors">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white dark:bg-neutral-900 border dark:border-neutral-800 rounded-2xl p-4 shadow-sm flex items-center gap-4 hover:border-indigo-200 dark:hover:border-indigo-800/50 transition-colors cursor-pointer group">
              <div className="w-10 h-10 rounded-full bg-indigo-100 dark:bg-indigo-900/30 flex items-center justify-center text-indigo-600 dark:text-indigo-400 shrink-0 group-hover:scale-110 transition-transform">
